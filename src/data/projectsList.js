...
export const projects = [
  {
    ...
    description:
      'A 3D cube interface for a 32-panel touch wall and laptops. I designed the navigation flow, camera motion, and lighting cues so users could rotate, tap, and access content quickly during demos. The system balances visual impact with clarity and performance for Fortune 500 presentations.',
  },
  {
    id: 'guardian-app',
    number: '02',
