import svgPaths from "./svg-wy1ujempoi";

function Frame() {
  return (
    <div className="absolute bg-[#d7a8a8] h-[31.594px] left-0 rounded-[21.789px] top-[10.89px] w-[135.092px]">
      <div className="content-stretch flex items-center justify-center overflow-clip px-[40.31px] py-[6.537px] relative rounded-[inherit] size-full">
        <p className="font-['Inter:Medium',sans-serif] font-medium leading-[17.741px] not-italic relative shrink-0 text-[13.073px] text-center text-nowrap text-white tracking-[-0.3132px]">Branding</p>
      </div>
          ...
          <div className="relative size-full" data-name="Vector">
            <div className="absolute inset-[3.06%_8.06%_8.06%_3.06%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
                <g id="Vector">
                  <path d={svgPaths.pe1f3e80} fill="var(--fill-0, #D7A8A8)" />
